 ...
 <div class="protected-container">
   <div class="icon">&#128274;</div>
   <h1>The Page is Protected</h1>
   <p>You got a email while registration with a Passcode</p>
   <div class="input-container">
     <input type="text" id="passcode" placeholder=" " required />
     <label for="password">Enter your Passcode</label>
   </div>
   <button>Unloack</button>
   <div class="success-message">
     <p>Passcode is correct. Removing Protection...</p>
   </div>
   <div class="error-message">
     <p>Passcode is incorrect. Please try again.</p>
   </div>
 </div>
   ...
   jQuery(document).ready(function($) {
     $('button').click(function() {
       ...
       $.ajax({
         ...
         data: {
           action: 'check_protected_passcode', // Action hook to handle the AJAX request in your functions.php 
           passcode: passcode,
         },
         dataType: 'json',
         success: function(response) {
           ...
           if (response.success) {
             ...
             // Add the passcode in cookies to remove the protection. Expires in 30 days
             document.cookie = "protected_passcode=" + passcode + "; max-age=" + 30 * 24 * 60 * 60 + "; path=/";
             //refresh the page
             setTimeout(function() {
               location.reload();
              }, 1000);
